...
C=======================================================================
C   Version 2.3.5 retune (Mar-14-2017)
C
...
C      *adjusted string tension to account for central production in CMS
C=======================================================================
...
C-----------------------------------------------------------------------
 ...
 100  FORMAT(' ','====================================================',
     ...
     *     /,' ','|                                                  |',
     *     /,' ','| last modifications: F. Riehn (03/14/2017)        |',
     *     /,' ','|     retune4 of Sibyll 2.3 from CORSIKA v76000    |',
     *     /,' ','|     adjusted string tension for LHC c. prod      |',      
     *     /,' ','====================================================',
     *     /)

      CALL PAR_INI_retune5
      CALL DIFF_INI
      CALL JET_INI
      CALL PDF_INI
      CALL BLOCK_INI
...
C..   23rc5.2prfTune5diq1strgJt3qqPt2strg1frgB1 == 23rc5.4
c     adjusted remnant pt
c     23rc5.4ptTune
      PAR(1) = 4.0000D-02
      PAR(2) = 2.5000D-01
      PAR(3) = 5.0000D-01
