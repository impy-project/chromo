...
C-----------------------------------------------------------------------
 ...
 100  FORMAT(' ','====================================================',
     ...
     *     /,' ','|                                                  |',
     *     /,' ','| last tampered with by: F. Riehn (09/15/2015)     |',
     *     /,' ','|                                                  |',
     *     /,' ','|  -->   post-ICRC release candidate + chm.fx <--  |',
     *     /,' ','====================================================',
     *     /)
...
C..   23rc1.4.19vec2all3lChm0 parameters
...
c     last in use: 146
     ...
     &     2*0.,0.9,0.2,4*0.04,0.5,0.8,0.5,           ! 20 
     ...
     &     0.,4 *0.,                                  ! 140
     &     1.0,0.,0.5,0.,0.5,5*0.,                    ! 150
     &     50*0./                                     ! 200
c     last in use:85
      DATA IPAR /9*0,1,0,1,8*0,20*0,9*0,0,2,9*0,100,39*0/
...
C    Count the bad entries
               IF(Ndebug.gt.3) Write(6,'(1x,a,i10)')
