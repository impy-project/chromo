...
C...............................................
      ...
      DO JB=1,NB
         ...
         IF (A .LE. 18.)  THEN
          ...
          ELSE
             JJA = IA1
             T1 = 2.*GAUSS (DENSA,0.D0,BMAX)
             JJA = IA2
             T2 = 2.*GAUSS (DENSA,0.D0,BMAX)
          ENDIF
          TB(JB) = (1.-U)*T1  + U*T2
      ENDDO
      RETURN
...
C...Data on `inelastic-production' nucleus-air cross section
     ...
     &3.842E+02,4.287E+02,4.940E+02,5.887E+02,6.922E+02,7.767E+02/
      DATA (SIGMA(J, 3),J=1,6) /
     &4.601E+02,5.149E+02,5.595E+02,6.663E+02,7.641E+02,8.446E+02/
      DATA (SIGMA(J, 4),J=1,6) /
     &4.881E+02,5.373E+02,6.005E+02,6.895E+02,7.716E+02,8.967E+02/
      DATA (SIGMA(J, 5),J=1,6) /
     &5.874E+02,6.176E+02,7.181E+02,7.993E+02,9.089E+02,1.031E+03/
      DATA (SIGMA(J, 6),J=1,6) /
     &7.054E+02,7.399E+02,8.388E+02,9.463E+02,1.080E+03,1.197E+03/
      DATA (SIGMA(J, 7),J=1,6) /
     &7.192E+02,7.611E+02,8.449E+02,9.539E+02,1.061E+03,1.176E+03/
      DATA (SIGMA(J, 8),J=1,6) /
     &7.550E+02,7.975E+02,9.153E+02,9.944E+02,1.126E+03,1.236E+03/
      DATA (SIGMA(J, 9),J=1,6) /
     &7.929E+02,8.392E+02,9.265E+02,1.059E+03,1.167E+03,1.262E+03/
      DATA (SIGMA(J, 10),J=1,6) /
     &8.157E+02,8.644E+02,9.512E+02,1.058E+03,1.182E+03,1.298E+03/
      DATA (SIGMA(J, 11),J=1,6) /
     &8.039E+02,8.587E+02,9.534E+02,1.055E+03,1.182E+03,1.298E+03/
      DATA (SIGMA(J, 12),J=1,6) /
     &8.515E+02,8.957E+02,9.869E+02,1.122E+03,1.253E+03,1.366E+03/
      DATA (SIGMA(J, 13),J=1,6) /
     &8.769E+02,9.100E+02,1.018E+03,1.119E+03,1.252E+03,1.341E+03/
      DATA (SIGMA(J, 14),J=1,6) /
     &9.058E+02,9.532E+02,1.057E+03,1.171E+03,1.302E+03,1.391E+03/
      DATA (SIGMA(J, 15),J=1,6) /
     &9.555E+02,9.799E+02,1.098E+03,1.201E+03,1.342E+03,1.444E+03/
      DATA (SIGMA(J, 16),J=1,6) /
     &1.009E+03,1.058E+03,1.149E+03,1.290E+03,1.414E+03,1.520E+03/
      DATA (SIGMA(J, 17),J=1,6) /
     &9.907E+02,1.045E+03,1.166E+03,1.290E+03,1.384E+03,1.516E+03/
      DATA (SIGMA(J, 18),J=1,6) /
     &1.036E+03,1.121E+03,1.198E+03,1.328E+03,1.470E+03,1.592E+03/
      DATA (SIGMA(J, 19),J=1,6) /
     &1.083E+03,1.162E+03,1.250E+03,1.371E+03,1.516E+03,1.661E+03/
      DATA (SIGMA(J, 20),J=1,6) /
     &1.146E+03,1.215E+03,1.295E+03,1.443E+03,1.544E+03,1.744E+03/
      DATA (SIGMA(J, 21),J=1,6) /
     &1.158E+03,1.234E+03,1.292E+03,1.467E+03,1.618E+03,1.750E+03/
      DATA (SIGMA(J, 22),J=1,6) /
     &1.153E+03,1.205E+03,1.329E+03,1.451E+03,1.596E+03,1.734E+03/
      DATA (SIGMA(J, 23),J=1,6) /
     &1.210E+03,1.274E+03,1.356E+03,1.493E+03,1.655E+03,1.803E+03/
      DATA (SIGMA(J, 24),J=1,6) /
     &1.212E+03,1.273E+03,1.398E+03,1.489E+03,1.641E+03,1.800E+03/
      DATA (SIGMA(J, 25),J=1,6) /
     &1.236E+03,1.315E+03,1.423E+03,1.561E+03,1.669E+03,1.855E+03/
      DATA (SIGMA(J, 26),J=1,6) /
     &1.279E+03,1.345E+03,1.431E+03,1.595E+03,1.734E+03,1.889E+03/
      DATA (SIGMA(J, 27),J=1,6) /
     &1.228E+03,1.304E+03,1.438E+03,1.546E+03,1.714E+03,1.836E+03/
      DATA (SIGMA(J, 28),J=1,6) /
     &1.289E+03,1.370E+03,1.451E+03,1.597E+03,1.754E+03,1.913E+03/
      DATA (SIGMA(J, 29),J=1,6) /
     &1.411E+03,1.469E+03,1.613E+03,1.777E+03,1.910E+03,2.075E+03/
      DATA (SIGMA(J, 30),J=1,6) /
     &1.347E+03,1.401E+03,1.498E+03,1.642E+03,1.816E+03,1.975E+03/
      DATA (SIGMA(J, 31),J=1,6) /
     &1.359E+03,1.448E+03,1.551E+03,1.694E+03,1.858E+03,2.007E+03/
      DATA (SIGMA(J, 32),J=1,6) /
     &1.358E+03,1.460E+03,1.559E+03,1.698E+03,1.842E+03,1.974E+03/
      DATA (SIGMA(J, 33),J=1,6) /
     &1.418E+03,1.448E+03,1.578E+03,1.727E+03,1.872E+03,2.047E+03/
      DATA (SIGMA(J, 34),J=1,6) /
     &1.433E+03,1.466E+03,1.605E+03,1.738E+03,1.892E+03,2.019E+03/
      DATA (SIGMA(J, 35),J=1,6) /
     &1.430E+03,1.511E+03,1.602E+03,1.752E+03,1.935E+03,2.060E+03/
      DATA (SIGMA(J, 36),J=1,6) /
     &1.462E+03,1.499E+03,1.653E+03,1.805E+03,1.920E+03,2.057E+03/
      DATA (SIGMA(J, 37),J=1,6) /
     &1.470E+03,1.520E+03,1.656E+03,1.818E+03,1.946E+03,2.131E+03/
      DATA (SIGMA(J, 38),J=1,6) /
     &1.470E+03,1.542E+03,1.691E+03,1.800E+03,1.968E+03,2.133E+03/
      DATA (SIGMA(J, 39),J=1,6) /
     &1.495E+03,1.588E+03,1.676E+03,1.834E+03,1.969E+03,2.163E+03/
      DATA (SIGMA(J, 40),J=1,6) /
     &1.525E+03,1.551E+03,1.722E+03,1.833E+03,2.020E+03,2.192E+03/
      DATA (SIGMA(J, 41),J=1,6) /
     &1.526E+03,1.615E+03,1.709E+03,1.899E+03,2.040E+03,2.181E+03/
      DATA (SIGMA(J, 42),J=1,6) /
     &1.510E+03,1.567E+03,1.716E+03,1.892E+03,2.056E+03,2.197E+03/
      DATA (SIGMA(J, 43),J=1,6) /
     &1.557E+03,1.658E+03,1.776E+03,1.898E+03,2.092E+03,2.200E+03/
      DATA (SIGMA(J, 44),J=1,6) /
     &1.556E+03,1.645E+03,1.752E+03,1.920E+03,2.091E+03,2.243E+03/
      DATA (SIGMA(J, 45),J=1,6) /
     &1.583E+03,1.663E+03,1.798E+03,1.940E+03,2.051E+03,2.263E+03/
      DATA (SIGMA(J, 46),J=1,6) /
     &1.599E+03,1.642E+03,1.799E+03,1.941E+03,2.107E+03,2.268E+03/
      DATA (SIGMA(J, 47),J=1,6) /
     &1.611E+03,1.692E+03,1.811E+03,1.956E+03,2.107E+03,2.264E+03/
      DATA (SIGMA(J, 48),J=1,6) /
     &1.625E+03,1.706E+03,1.819E+03,1.986E+03,2.139E+03,2.354E+03/
      DATA (SIGMA(J, 49),J=1,6) /
     &1.666E+03,1.737E+03,1.854E+03,1.971E+03,2.160E+03,2.318E+03/
      DATA (SIGMA(J, 50),J=1,6) /
     &1.648E+03,1.747E+03,1.856E+03,2.023E+03,2.181E+03,2.352E+03/
      DATA (SIGMA(J, 51),J=1,6) /
     &1.653E+03,1.763E+03,1.868E+03,2.015E+03,2.203E+03,2.386E+03/
      DATA (SIGMA(J, 52),J=1,6) /
     &1.690E+03,1.720E+03,1.902E+03,2.027E+03,2.189E+03,2.357E+03/
      DATA (SIGMA(J, 53),J=1,6) /
     &1.690E+03,1.750E+03,1.921E+03,2.059E+03,2.208E+03,2.417E+03/
      DATA (SIGMA(J, 54),J=1,6) /
     &1.705E+03,1.781E+03,1.911E+03,2.073E+03,2.242E+03,2.411E+03/
      DATA (SIGMA(J, 55),J=1,6) /
     &1.714E+03,1.806E+03,1.896E+03,2.100E+03,2.253E+03,2.411E+03/
      DATA (SIGMA(J, 56),J=1,6) /
     &1.774E+03,1.813E+03,1.954E+03,2.098E+03,2.280E+03,2.482E+03/
 
      DATA (SIGQE(J, 2),J=1,6) /
     &4.141E+01,3.708E+01,5.428E+01,8.696E+01,1.403E+02,1.885E+02/
      DATA (SIGQE(J, 3),J=1,6) /
     &4.357E+01,3.894E+01,5.177E+01,9.675E+01,1.447E+02,2.029E+02/
      DATA (SIGQE(J, 4),J=1,6) /
     &4.123E+01,3.933E+01,6.070E+01,9.482E+01,1.474E+02,2.023E+02/
      DATA (SIGQE(J, 5),J=1,6) /
     &4.681E+01,4.287E+01,6.381E+01,1.050E+02,1.519E+02,2.198E+02/
      DATA (SIGQE(J, 6),J=1,6) /
     &5.407E+01,5.195E+01,6.723E+01,1.108E+02,1.750E+02,2.368E+02/
      DATA (SIGQE(J, 7),J=1,6) /
     &4.975E+01,4.936E+01,6.880E+01,1.162E+02,1.689E+02,2.329E+02/
      DATA (SIGQE(J, 8),J=1,6) /
     &5.361E+01,5.027E+01,6.858E+01,1.177E+02,1.759E+02,2.412E+02/
      DATA (SIGQE(J, 9),J=1,6) /
     &4.980E+01,5.063E+01,7.210E+01,1.196E+02,1.806E+02,2.299E+02/
      DATA (SIGQE(J, 10),J=1,6) /
     &5.170E+01,5.070E+01,7.105E+01,1.182E+02,1.679E+02,2.411E+02/
      DATA (SIGQE(J, 11),J=1,6) /
     &4.950E+01,4.950E+01,7.286E+01,1.137E+02,1.769E+02,2.477E+02/
      DATA (SIGQE(J, 12),J=1,6) /
     &5.262E+01,5.133E+01,7.110E+01,1.204E+02,1.789E+02,2.501E+02/
      DATA (SIGQE(J, 13),J=1,6) /
     &5.320E+01,5.378E+01,6.847E+01,1.200E+02,1.805E+02,2.442E+02/
      DATA (SIGQE(J, 14),J=1,6) /
     &5.638E+01,5.271E+01,6.985E+01,1.209E+02,1.867E+02,2.610E+02/
      DATA (SIGQE(J, 15),J=1,6) /
     &5.294E+01,5.353E+01,7.435E+01,1.211E+02,1.899E+02,2.612E+02/
      DATA (SIGQE(J, 16),J=1,6) /
     &5.668E+01,5.254E+01,7.557E+01,1.269E+02,1.917E+02,2.707E+02/
      DATA (SIGQE(J, 17),J=1,6) /
     &5.456E+01,5.721E+01,7.481E+01,1.208E+02,1.859E+02,2.658E+02/
      DATA (SIGQE(J, 18),J=1,6) /
     &5.901E+01,5.382E+01,7.591E+01,1.246E+02,1.872E+02,2.874E+02/
      DATA (SIGQE(J, 19),J=1,6) /
     &6.328E+01,6.116E+01,8.451E+01,1.318E+02,2.088E+02,2.749E+02/
      DATA (SIGQE(J, 20),J=1,6) /
     &5.779E+01,5.924E+01,8.382E+01,1.370E+02,2.062E+02,2.837E+02/
      DATA (SIGQE(J, 21),J=1,6) /
     &7.155E+01,5.732E+01,8.231E+01,1.363E+02,2.047E+02,2.820E+02/
      DATA (SIGQE(J, 22),J=1,6) /
     &6.699E+01,5.651E+01,8.511E+01,1.477E+02,2.031E+02,2.921E+02/
      DATA (SIGQE(J, 23),J=1,6) /
     &6.179E+01,6.269E+01,9.395E+01,1.437E+02,2.195E+02,2.964E+02/
      DATA (SIGQE(J, 24),J=1,6) /
     &6.784E+01,6.028E+01,8.622E+01,1.279E+02,2.214E+02,2.867E+02/
      DATA (SIGQE(J, 25),J=1,6) /
     &6.589E+01,5.795E+01,8.890E+01,1.385E+02,2.055E+02,2.988E+02/
      DATA (SIGQE(J, 26),J=1,6) /
     &6.364E+01,6.325E+01,8.942E+01,1.421E+02,2.128E+02,3.083E+02/
      DATA (SIGQE(J, 27),J=1,6) /
     &6.449E+01,6.664E+01,8.986E+01,1.453E+02,2.140E+02,2.932E+02/
      DATA (SIGQE(J, 28),J=1,6) /
     &7.284E+01,6.139E+01,8.867E+01,1.425E+02,2.179E+02,2.978E+02/
      DATA (SIGQE(J, 29),J=1,6) /
     &7.221E+01,7.085E+01,9.079E+01,1.482E+02,2.277E+02,2.913E+02/
      DATA (SIGQE(J, 30),J=1,6) /
     &6.928E+01,6.294E+01,8.935E+01,1.463E+02,2.265E+02,2.834E+02/
      DATA (SIGQE(J, 31),J=1,6) /
     &6.611E+01,6.586E+01,9.133E+01,1.461E+02,2.201E+02,2.959E+02/
      DATA (SIGQE(J, 32),J=1,6) /
     &6.401E+01,6.177E+01,8.971E+01,1.480E+02,2.155E+02,3.152E+02/
      DATA (SIGQE(J, 33),J=1,6) /
     &7.057E+01,6.918E+01,8.410E+01,1.465E+02,2.288E+02,3.088E+02/
      DATA (SIGQE(J, 34),J=1,6) /
     &6.453E+01,7.020E+01,9.272E+01,1.517E+02,2.189E+02,2.999E+02/
      DATA (SIGQE(J, 35),J=1,6) /
     &6.741E+01,6.295E+01,9.323E+01,1.536E+02,2.190E+02,2.930E+02/
      DATA (SIGQE(J, 36),J=1,6) /
     &6.807E+01,7.046E+01,1.025E+02,1.565E+02,2.315E+02,3.090E+02/
      DATA (SIGQE(J, 37),J=1,6) /
     &8.082E+01,6.565E+01,9.160E+01,1.572E+02,2.229E+02,3.125E+02/
      DATA (SIGQE(J, 38),J=1,6) /
     &6.494E+01,6.964E+01,9.089E+01,1.653E+02,2.336E+02,3.120E+02/
      DATA (SIGQE(J, 39),J=1,6) /
     &6.833E+01,6.860E+01,8.933E+01,1.601E+02,2.261E+02,3.167E+02/
      DATA (SIGQE(J, 40),J=1,6) /
     &7.021E+01,6.866E+01,8.437E+01,1.588E+02,2.249E+02,2.941E+02/
      DATA (SIGQE(J, 41),J=1,6) /
     &7.122E+01,6.205E+01,9.545E+01,1.582E+02,2.335E+02,3.395E+02/
      DATA (SIGQE(J, 42),J=1,6) /
     &7.265E+01,6.936E+01,9.486E+01,1.505E+02,2.379E+02,3.248E+02/
      DATA (SIGQE(J, 43),J=1,6) /
     &7.048E+01,7.539E+01,9.192E+01,1.566E+02,2.532E+02,3.182E+02/
      DATA (SIGQE(J, 44),J=1,6) /
     &6.650E+01,7.139E+01,9.862E+01,1.602E+02,2.289E+02,3.077E+02/
      DATA (SIGQE(J, 45),J=1,6) /
     &7.511E+01,6.893E+01,9.245E+01,1.641E+02,2.519E+02,3.381E+02/
      DATA (SIGQE(J, 46),J=1,6) /
     &6.437E+01,6.894E+01,8.697E+01,1.544E+02,2.391E+02,3.213E+02/
      DATA (SIGQE(J, 47),J=1,6) /
     &7.980E+01,6.958E+01,1.022E+02,1.609E+02,2.408E+02,3.246E+02/
      DATA (SIGQE(J, 48),J=1,6) /
     &7.265E+01,7.313E+01,8.989E+01,1.578E+02,2.387E+02,3.235E+02/
      DATA (SIGQE(J, 49),J=1,6) /
     &6.959E+01,6.337E+01,9.084E+01,1.656E+02,2.331E+02,3.226E+02/
      DATA (SIGQE(J, 50),J=1,6) /
     &7.371E+01,6.807E+01,9.726E+01,1.535E+02,2.445E+02,3.189E+02/
      DATA (SIGQE(J, 51),J=1,6) /
     &7.882E+01,6.680E+01,9.377E+01,1.629E+02,2.448E+02,3.297E+02/
      DATA (SIGQE(J, 52),J=1,6) /
     &7.223E+01,6.794E+01,9.925E+01,1.738E+02,2.446E+02,3.162E+02/
      DATA (SIGQE(J, 53),J=1,6) /
     &7.703E+01,6.971E+01,9.601E+01,1.595E+02,2.484E+02,3.265E+02/
      DATA (SIGQE(J, 54),J=1,6) /
     &7.549E+01,7.459E+01,8.984E+01,1.645E+02,2.348E+02,3.201E+02/
      DATA (SIGQE(J, 55),J=1,6) /
     &7.891E+01,6.840E+01,1.017E+02,1.698E+02,2.501E+02,3.429E+02/
      DATA (SIGQE(J, 56),J=1,6) /
     &7.545E+01,6.673E+01,1.057E+02,1.684E+02,2.424E+02,3.181E+02/
...
c     assumed to be universal, i.e. same coupling used for proton, pion and kaons
     ...
     &        SSIGT, SSIGEL, SSIGQE, SIGSD, SIGQSD )
         ...
         ALINT(J,1) = 1./(AVOG*SSIGA(J,1)/ATARGET) ! interaction length in air
C...pi-air
...
C-----------------------------------------------------------------------
     ...
     &     SSIG0(61,3),SSIGA(61,3),ALINT(61,3),NSQS
      ...
      ELSE
         ...
         J = MIN(J,NSQS-2)
         T = T-FLOAT(J)
         FSIGHAIR = ((1.-T)*SSIGA(J+1,KK(L)) + T*SSIGA(J+2,KK(L)))
      ENDIF     
      RETURN
      END
