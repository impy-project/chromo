...
c linear fit of the 2 components of G as a function of x
        !soft (taking into account hard)
        call pompar(alpsf,betsf,0)
        !sh
        call pompar(alpsh,betsh,1)
c        betsh=0.31
...
c the chiŁsquare chi2, and the goodness-of-fit probability q (that the fit
