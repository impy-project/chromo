...
c and store entry channel in temporary observables
      bdum=paulibl(ind1,cdens,-1000d0)
      tsqrts=sqrts
      tstot=stot
      tsigpart=sigpart
      ...
      elseif(ind2.gt.0) then
         bdum=paulibl(ind2,cdens_,-1000d0)
...
c     $   "#############################################################"
c      write (*,*)
c     $   "##     UrQMD uses Pythia6.409 by T. Sjorstrand             ##"
c      write (*,*)
c     $   "#############################################################"
c      write (*,*)
c     $   "##                                                         ##"
c      write (*,*)
c     $   "##     If hydrodynamic evolution is switched on (CTO 45 1) ##"
c      write (*,*)
c     $   "##     UrQMD uses the SHASTA algorithm by D. Rischke       ##"
c      write (*,*)
c     $   "##     Please cite when using the hybrid code:             ##"
c      write (*,*) 
c     $   "##     D. Rischke et al., Nucl.Phys. A 595 (1995) 346      ##"
c      write (*,*)
c     $   "##     D. Rischke et al., Nucl.Phys. A 595 (1995) 383      ##"
c      write (*,*)
c     $   "##     H. Petersen et al., Phys.Rev. C78 (2008) 044901     ##"
c      write (*,*)        
c     $   "##                                                         ##"
c      write (*,*)        
     $   "#############################################################"
