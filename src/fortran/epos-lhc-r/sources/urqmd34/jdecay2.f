...
C           MASS=SUM of all rest masses of the REMAINING particles.             
            ...
            B=(1.+U-XIMIN)          ! Used in FAST event generator.             
...
C                                                                               
            RECI=1./dble(I)                                                    
            S=1./(dble(I)-dble(IMIN1)*DELXI/B)    ! The probability           
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      real*8 wtmax,rm,sum,pi,sum1,sum2,pcms,ranff,gamma,bp,phi,qcm
     $     ,r1234
