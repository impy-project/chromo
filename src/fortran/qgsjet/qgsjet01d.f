...
C----------------------------------------------------------------------C
C             last modification:  Jan. 30, 2013                        C
C                        Version qgsjet01d.f                           C
C correction of inconsistent array declaration (IQV1 and IQV2)         C
C----------------------------------------------------------------------C
C  modifications are marked by cdh
C=======================================================================

      SUBROUTINE PSAINI( DATDIR )
...
203       FORMAT(2X,'PSCAJET: NEW BRANCHING AT LEVEL NLEV=',I2,' NROW=',
     *           I2,/,4X,' EFFECTIVE MOMENTUM Q=',E10.3,2X,' Z=',E10.3)
          GOTO 2
        ELSE
...
ctp060202 20      IF(NW.NE.0)CALL PSSHAR(LS,NHP,NW,NT)
...
202     FORMAT(2X,'PSFAZ=',E10.3,2X,'FSOFT=',E10.3,2X,'FSHARD=',E10.3,/
     *    ,4X,'FHARD=',3E10.3)
        RETURN
        END
C=======================================================================
...
c-----------------------------------------------------------------------
        ...
        INTEGER DEBUG
        CHARACTER*2 TYQ
ctp060202        DIMENSION EP(4,2),EPT(4),EPT0(4),EP3(4),EPJ(4),EPJ1(4),EY(3),
...
c interaction)
ctp        IF(DEBUG.GE.2)WRITE (MONIOU,208)ILAD, SI,IQC,EPT
ctp 208     FORMAT(2X,'PSHOT: ',I2,'-TH HARD LADDER;',
ctp     *  ' MASS SQUARED FOR THE LADDDER:',E10.3,/,
ctp     *  4X,'LADDER END FLAVORS:',2I3,/,4X,
ctp     *  'LADDER 4-MOMENTUM: ',4E10.3)
...
c-----------------------------------------------------------------------
        IMPLICIT DOUBLE PRECISION (A-H,O-Z)
        INTEGER DEBUG
ctp060202        DIMENSION EP3(4),EP1(4),EP2(4),EY(3)
