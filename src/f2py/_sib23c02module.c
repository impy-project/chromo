 ...
 * Generation date: Sun Jan 15 13:06:02 2023
...
"rval : input float";
/* extern void F_FUNC(npyrng,NPYRNG)(double*); */
static PyObject *f2py_rout__sib23c02_npyrng(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable rval */
    f2py_success = double_from_pyobj(&rval,rval_capi,"_sib23c02.npyrng() 1st argument (rval) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/*frompyobj*/
  /* Processing variable dummy */
    f2py_success = int_from_pyobj(&dummy,dummy_capi,"_sib23c02.gasdev() 1st argument (dummy) can't be converted to int");
  if (f2py_success) {
