...
/*frompyobj*/
  ...
  if (capi_p0_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : _sib23c02_error,"failed in converting 2nd argument `p0' of _sib23c02.decpar to C/Fortran array" );
  ...
  if (capi_ll_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _sib23c02_error,"failed in converting 4th argument `ll' of _sib23c02.decpar to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_p_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _sib23c02_error,"failed in converting 5th argument `p' of _sib23c02.decpar to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_sigdif_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _sib23c02_error,"failed in converting hidden `sigdif' of _sib23c02.sib_sigma_hp to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*********************************** gasdev ***********************************/
static char doc_f2py_rout__sib23c02_gasdev[] = "\
gasdev = gasdev(idum)\n\nWrapper for ``gasdev``.\
\n\nParameters\n----------\n"
"idum : input int\n"
"\nReturns\n-------\n"
"gasdev : float";
/* extern void F_WRAPPEDFUNC(gasdev,GASDEV)(double*,int*); */
static PyObject *f2py_rout__sib23c02_gasdev(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable idum */
    f2py_success = int_from_pyobj(&idum,idum_capi,"_sib23c02.gasdev() 1st argument (idum) can't be converted to int");
  if (f2py_success) {
...
/******************************** init_rmmard ********************************/
static char doc_f2py_rout__sib23c02_init_rmmard[] = "\
init_rmmard(iseedin)\n\nWrapper for ``init_rmmard``.\
\n\nParameters\n----------\n"
"iseedin : input int";
/* extern void F_FUNC_US(init_rmmard,INIT_RMMARD)(int*); */
static PyObject *f2py_rout__sib23c02_init_rmmard(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_sib23c02.init_rmmard",\
    capi_kwlist,&iseedin_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable iseedin */
    f2py_success = int_from_pyobj(&iseedin,iseedin_capi,"_sib23c02.init_rmmard() 1st argument (iseedin) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"init_rmmard",-1,{{-1}},0,(char *)F_FUNC_US(init_rmmard,INIT_RMMARD),(f2py_init_func)f2py_rout__sib23c02_init_rmmard,doc_f2py_rout__sib23c02_init_rmmard},
...
PyMODINIT_FUNC PyInit__sib23c02(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _sib23c02 (failed to import numpy)"); return m;}
