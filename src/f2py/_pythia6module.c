 ...
 * Generation date: Thu Sep 15 14:05:24 2022
...
"iseedin : input int";
/* extern void F_FUNC_US(init_rmmard,INIT_RMMARD)(int*); */
static PyObject *f2py_rout__pythia6_init_rmmard(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_pythia6.init_rmmard",\
    capi_kwlist,&iseedin_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable iseedin */
    f2py_success = int_from_pyobj(&iseedin,iseedin_capi,"_pythia6.init_rmmard() 1st argument (iseedin) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
