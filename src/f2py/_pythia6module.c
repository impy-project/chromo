...
#else
#define RETVAL
PyMODINIT_FUNC init_pythia6(void) {
#endif
  int i;
  PyObject *m,*d, *s, *tmp;
#if PY_VERSION_HEX >= 0x03000000
...
#else
  m = _pythia6_module = Py_InitModule("_pythia6", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _pythia6 (failed to import numpy)"); return RETVAL;}
