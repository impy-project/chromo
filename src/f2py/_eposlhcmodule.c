 ...
 * Generation date: Tue Sep 12 04:22:29 2023
...
extern void F_FUNC(alist,ALIST)(string,int*,int*,size_t);
...
/*********************************** alist ***********************************/
static char doc_f2py_rout__eposlhc_alist[] = "\
alist(text,n1,n2)\n\nWrapper for ``alist``.\
\n\nParameters\n----------\n"
"text : input string(len=-1)\n"
"n1 : input int\n"
"n2 : input int";
/* extern void F_FUNC(alist,ALIST)(string,int*,int*,size_t); */
static PyObject *f2py_rout__eposlhc_alist(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*decl*/
    ...
    string text = NULL;
    int slen(text);
    PyObject *text_capi = Py_None;
    int n1 = 0;
    PyObject *n1_capi = Py_None;
    int n2 = 0;
    PyObject *n2_capi = Py_None;
    static char *capi_kwlist[] = {"text","n1","n2",NULL};
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOO|:_eposlhc.alist",\
        capi_kwlist,&text_capi,&n1_capi,&n2_capi))
        return NULL;
/*frompyobj*/
    /* Processing variable text */
    slen(text) = -1;
    f2py_success = string_from_pyobj(&text,&slen(text),"",text_capi,"string_from_pyobj failed in converting 1st argument`text' of _eposlhc.alist to C string");
    if (f2py_success) {
        STRINGPADN(text, slen(text), '\0', ' ');
    /* Processing variable n1 */
        f2py_success = int_from_pyobj(&n1,n1_capi,"_eposlhc.alist() 2nd argument (n1) can't be converted to int");
    if (f2py_success) {
    /* Processing variable n2 */
        f2py_success = int_from_pyobj(&n2,n2_capi,"_eposlhc.alist() 3rd argument (n2) can't be converted to int");
    if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
                (*f2py_func)(text,&n1,&n2,slen(text));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable n1 */
        STRINGFREE(text);
    }  /*if (f2py_success) of text*/
    /* End of cleaning variable text */
/*end of cleanupfrompyobj*/
    if (capi_buildvalue == NULL) {
/*routdebugfailure*/
    } else {
...
static FortranDataDef f2py_cxyzt_def[] = {
  {"xptl",1,{{200000}},NPY_FLOAT},
  {"yptl",1,{{200000}},NPY_FLOAT},
  {"zptl",1,{{200000}},NPY_FLOAT},
  {"tptl",1,{{200000}},NPY_FLOAT},
  {"optl",1,{{200000}},NPY_FLOAT},
  {"uptl",1,{{200000}},NPY_FLOAT},
  {"sptl",1,{{200000}},NPY_FLOAT},
  {"rptl",2,{{200000,3}},NPY_FLOAT},
  {NULL}
};
static void f2py_setup_cxyzt(char *xptl,char *yptl,char *zptl,char *tptl,char *optl,char *uptl,char *sptl,char *rptl) {
  int i_f2py=0;
  f2py_cxyzt_def[i_f2py++].data = xptl;
  f2py_cxyzt_def[i_f2py++].data = yptl;
  f2py_cxyzt_def[i_f2py++].data = zptl;
  f2py_cxyzt_def[i_f2py++].data = tptl;
  f2py_cxyzt_def[i_f2py++].data = optl;
  f2py_cxyzt_def[i_f2py++].data = uptl;
  f2py_cxyzt_def[i_f2py++].data = sptl;
  f2py_cxyzt_def[i_f2py++].data = rptl;
}
extern void F_FUNC(f2pyinitcxyzt,F2PYINITCXYZT)(void(*)(char*,char*,char*,char*,char*,char*,char*,char*));
static void f2py_init_cxyzt(void) {
  F_FUNC(f2pyinitcxyzt,F2PYINITCXYZT)(f2py_setup_cxyzt);
}
...
static FortranDataDef f2py_routine_defs[] = {
    ...
    {"alist",-1,{{-1}},0,(char *)F_FUNC(alist,ALIST),(f2py_init_func)f2py_rout__eposlhc_alist,doc_f2py_rout__eposlhc_alist},
...
PyMODINIT_FUNC PyInit__eposlhc(void) {
    ...
    s = PyUnicode_FromString(
        "This module '_eposlhc' is auto-generated with f2py (version:1.23.0).\nFunctions:\n"
"    aaset(iop)\n"
"    hepmcstore()\n"
"    afinal()\n"
"    ainit()\n"
...
/*eof initf90modhooks*/
  ...
  Py_DECREF(tmp);
  tmp = PyFortranObject_New(f2py_cxyzt_def,f2py_init_cxyzt);
  F2PyDict_SetItemString(d, "cxyzt", tmp);
  Py_DECREF(tmp);
