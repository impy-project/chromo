 ...
 * Generation date: Tue Dec  6 18:25:38 2022
...
extern void F_FUNC(initepos,INITEPOS)(float*,float*,string,int*,int*,int*,size_t);
...
initepos(seed,emax,datpath,lpath,idbg,iou)\n\nWrapper for ``initepos``.\
\n\nParameters\n----------\n"
"seed : input float\n"
"emax : input float\n"
...
static PyObject *f2py_rout__eposlhc_initepos(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,string,int*,int*,int*,size_t)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
    ...
    static char *capi_kwlist[] = {"seed","emax","datpath","lpath","idbg","iou",NULL};
...
#endif
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOOOOO|:_eposlhc.initepos",\
        capi_kwlist,&seed_capi,&emax_capi,&datpath_capi,&lpath_capi,&idbg_capi,&iou_capi))
        return NULL;
/*frompyobj*/
    ...
    /* Processing variable idbg */
        f2py_success = int_from_pyobj(&idbg,idbg_capi,"_eposlhc.initepos() 5th argument (idbg) can't be converted to int");
    if (f2py_success) {
    /* Processing variable iou */
        f2py_success = int_from_pyobj(&iou,iou_capi,"_eposlhc.initepos() 6th argument (iou) can't be converted to int");
    if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
                (*f2py_func)(&seed,&emax,datpath,&lpath,&idbg,&iou,slen(datpath));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
