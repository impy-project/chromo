 ...
 * Generation date: Thu Sep 15 14:05:26 2022
...
extern void F_FUNC(initializeepos,INITIALIZEEPOS)(float*,float*,string,int*,int*,int*,int*,int*,int*,int*,int*,int*,int*,size_t);
extern void F_FUNC(initeposevt,INITEPOSEVT)(float*,float*,int*,int*,int*,int*,int*,int*);
extern void F_FUNC(setstable,SETSTABLE)(int*);
extern void F_FUNC(setunstable,SETUNSTABLE)(int*);
...
/******************************* initializeepos *******************************/
static char doc_f2py_rout__eposlhc_initializeepos[] = "\
initializeepos(seed,emax,datpath,lpath,ifram,ippdg,itpdg,iapro,izpro,iatar,iztar,idebug,iou)\n\nWrapper for ``initializeepos``.\
\n\nParameters\n----------\n"
"seed : input float\n"
"emax : input float\n"
...
"iou : input int";
/* extern void F_FUNC(initializeepos,INITIALIZEEPOS)(float*,float*,string,int*,int*,int*,int*,int*,int*,int*,int*,int*,int*,size_t); */
static PyObject *f2py_rout__eposlhc_initializeepos(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,string,int*,int*,int*,int*,int*,int*,int*,int*,int*,int*,size_t)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
  ...
  int iapro = 0;
  PyObject *iapro_capi = Py_None;
  int izpro = 0;
  PyObject *izpro_capi = Py_None;
  int iatar = 0;
  PyObject *iatar_capi = Py_None;
  int iztar = 0;
  PyObject *iztar_capi = Py_None;
  int idebug = 0;
  PyObject *idebug_capi = Py_None;
  int iou = 0;
  PyObject *iou_capi = Py_None;
  static char *capi_kwlist[] = {"seed","emax","datpath","lpath","ifram","ippdg","itpdg","iapro","izpro","iatar","iztar","idebug","iou",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOOO|:_eposlhc.initializeepos",\
    capi_kwlist,&seed_capi,&emax_capi,&datpath_capi,&lpath_capi,&ifram_capi,&ippdg_capi,&itpdg_capi,&iapro_capi,&izpro_capi,&iatar_capi,&iztar_capi,&idebug_capi,&iou_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable seed */
    f2py_success = float_from_pyobj(&seed,seed_capi,"_eposlhc.initializeepos() 1st argument (seed) can't be converted to float");
  if (f2py_success) {
  /* Processing variable emax */
    f2py_success = float_from_pyobj(&emax,emax_capi,"_eposlhc.initializeepos() 2nd argument (emax) can't be converted to float");
  if (f2py_success) {
  /* Processing variable datpath */
  slen(datpath) = -1;
  f2py_success = string_from_pyobj(&datpath,&slen(datpath),"",datpath_capi,"string_from_pyobj failed in converting 3rd argument `datpath' of _eposlhc.initializeepos to C string");
  if (f2py_success) {
  /* Processing variable lpath */
    f2py_success = int_from_pyobj(&lpath,lpath_capi,"_eposlhc.initializeepos() 4th argument (lpath) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ifram */
    f2py_success = int_from_pyobj(&ifram,ifram_capi,"_eposlhc.initializeepos() 5th argument (ifram) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ippdg */
    f2py_success = int_from_pyobj(&ippdg,ippdg_capi,"_eposlhc.initializeepos() 6th argument (ippdg) can't be converted to int");
  if (f2py_success) {
  /* Processing variable itpdg */
    f2py_success = int_from_pyobj(&itpdg,itpdg_capi,"_eposlhc.initializeepos() 7th argument (itpdg) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iapro */
    f2py_success = int_from_pyobj(&iapro,iapro_capi,"_eposlhc.initializeepos() 8th argument (iapro) can't be converted to int");
  if (f2py_success) {
  /* Processing variable izpro */
    f2py_success = int_from_pyobj(&izpro,izpro_capi,"_eposlhc.initializeepos() 9th argument (izpro) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iatar */
    f2py_success = int_from_pyobj(&iatar,iatar_capi,"_eposlhc.initializeepos() 10th argument (iatar) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iztar */
    f2py_success = int_from_pyobj(&iztar,iztar_capi,"_eposlhc.initializeepos() 11st argument (iztar) can't be converted to int");
  if (f2py_success) {
  /* Processing variable idebug */
    f2py_success = int_from_pyobj(&idebug,idebug_capi,"_eposlhc.initializeepos() 12nd argument (idebug) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iou */
    f2py_success = int_from_pyobj(&iou,iou_capi,"_eposlhc.initializeepos() 13rd argument (iou) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
        (*f2py_func)(&seed,&emax,datpath,&lpath,&ifram,&ippdg,&itpdg,&iapro,&izpro,&iatar,&iztar,&idebug,&iou,slen(datpath));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  ...
  } /*if (f2py_success) of idebug*/
  /* End of cleaning variable idebug */
  } /*if (f2py_success) of iztar*/
  /* End of cleaning variable iztar */
  } /*if (f2py_success) of iatar*/
  /* End of cleaning variable iatar */
  } /*if (f2py_success) of izpro*/
  /* End of cleaning variable izpro */
  } /*if (f2py_success) of iapro*/
  /* End of cleaning variable iapro */
...
/*************************** end of initializeepos ***************************/

/******************************** initeposevt ********************************/
static char doc_f2py_rout__eposlhc_initeposevt[] = "\
initeposevt(ecm,ela,idpro,idtar,iapro,izpro,iatar,iztar)\n\nWrapper for ``initeposevt``.\
\n\nParameters\n----------\n"
"ecm : input float\n"
"ela : input float\n"
"idpro : input int\n"
...
/*decl*/
  ...
  int idpro = 0;
  PyObject *idpro_capi = Py_None;
  int idtar = 0;
  PyObject *idtar_capi = Py_None;
  int iapro = 0;
  PyObject *iapro_capi = Py_None;
  int izpro = 0;
  PyObject *izpro_capi = Py_None;
  ...
  int iztar = 0;
  PyObject *iztar_capi = Py_None;
  static char *capi_kwlist[] = {"ecm","ela","idpro","idtar","iapro","izpro","iatar","iztar",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOO|:_eposlhc.initeposevt",\
    capi_kwlist,&ecm_capi,&ela_capi,&idpro_capi,&idtar_capi,&iapro_capi,&izpro_capi,&iatar_capi,&iztar_capi))
    return NULL;
/*frompyobj*/
  ...
  if (f2py_success) {
  /* Processing variable idpro */
    f2py_success = int_from_pyobj(&idpro,idpro_capi,"_eposlhc.initeposevt() 3rd argument (idpro) can't be converted to int");
  if (f2py_success) {
  /* Processing variable idtar */
    f2py_success = int_from_pyobj(&idtar,idtar_capi,"_eposlhc.initeposevt() 4th argument (idtar) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iapro */
    f2py_success = int_from_pyobj(&iapro,iapro_capi,"_eposlhc.initeposevt() 5th argument (iapro) can't be converted to int");
  if (f2py_success) {
  /* Processing variable izpro */
    f2py_success = int_from_pyobj(&izpro,izpro_capi,"_eposlhc.initeposevt() 6th argument (izpro) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iatar */
    f2py_success = int_from_pyobj(&iatar,iatar_capi,"_eposlhc.initeposevt() 7th argument (iatar) can't be converted to int");
  if (f2py_success) {
  /* Processing variable iztar */
    f2py_success = int_from_pyobj(&iztar,iztar_capi,"_eposlhc.initeposevt() 8th argument (iztar) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
        (*f2py_func)(&ecm,&ela,&idpro,&idtar,&iapro,&izpro,&iatar,&iztar);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  ...
  /* End of cleaning variable iapro */
  } /*if (f2py_success) of idtar*/
  /* End of cleaning variable idtar */
  } /*if (f2py_success) of idpro*/
  /* End of cleaning variable idpro */
...
/********************************* setstable *********************************/
static char doc_f2py_rout__eposlhc_setstable[] = "\
setstable(idpdg)\n\nWrapper for ``setstable``.\
\n\nParameters\n----------\n"
"idpdg : input int";
/* extern void F_FUNC(setstable,SETSTABLE)(int*); */
static PyObject *f2py_rout__eposlhc_setstable(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_eposlhc.setstable",\
    capi_kwlist,&idpdg_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable idpdg */
    f2py_success = int_from_pyobj(&idpdg,idpdg_capi,"_eposlhc.setstable() 1st argument (idpdg) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************** setunstable ********************************/
static char doc_f2py_rout__eposlhc_setunstable[] = "\
setunstable(idpdg)\n\nWrapper for ``setunstable``.\
\n\nParameters\n----------\n"
"idpdg : input int";
/* extern void F_FUNC(setunstable,SETUNSTABLE)(int*); */
static PyObject *f2py_rout__eposlhc_setunstable(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_eposlhc.setunstable",\
    capi_kwlist,&idpdg_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable idpdg */
    f2py_success = int_from_pyobj(&idpdg,idpdg_capi,"_eposlhc.setunstable() 1st argument (idpdg) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************** init_rmmard ********************************/
static char doc_f2py_rout__eposlhc_init_rmmard[] = "\
init_rmmard(iseedin)\n\nWrapper for ``init_rmmard``.\
\n\nParameters\n----------\n"
"iseedin : input int";
/* extern void F_FUNC_US(init_rmmard,INIT_RMMARD)(int*); */
static PyObject *f2py_rout__eposlhc_init_rmmard(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_eposlhc.init_rmmard",\
    capi_kwlist,&iseedin_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable iseedin */
    f2py_success = int_from_pyobj(&iseedin,iseedin_capi,"_eposlhc.init_rmmard() 1st argument (iseedin) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/****************************** impy_openlogfile ******************************/
static char doc_f2py_rout__eposlhc_impy_openlogfile[] = "\
impy_openlogfile(fname,opunit)\n\nWrapper for ``impy_openlogfile``.\
\n\nParameters\n----------\n"
"fname : input string(len=300)\n"
"opunit : input int";
/* extern void F_FUNC_US(impy_openlogfile,IMPY_OPENLOGFILE)(string,int*,size_t); */
static PyObject *f2py_rout__eposlhc_impy_openlogfile(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO|:_eposlhc.impy_openlogfile",\
    capi_kwlist,&fname_capi,&opunit_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable fname */
  slen(fname) = 300;
  f2py_success = string_from_pyobj(&fname,&slen(fname),"",fname_capi,"string_from_pyobj failed in converting 1st argument `fname' of _eposlhc.impy_openlogfile to C string");
  if (f2py_success) {
  /* Processing variable opunit */
    f2py_success = int_from_pyobj(&opunit,opunit_capi,"_eposlhc.impy_openlogfile() 2nd argument (opunit) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/***************************** impy_closelogfile *****************************/
static char doc_f2py_rout__eposlhc_impy_closelogfile[] = "\
impy_closelogfile(opunit)\n\nWrapper for ``impy_closelogfile``.\
\n\nParameters\n----------\n"
"opunit : input int";
/* extern void F_FUNC_US(impy_closelogfile,IMPY_CLOSELOGFILE)(int*); */
static PyObject *f2py_rout__eposlhc_impy_closelogfile(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_eposlhc.impy_closelogfile",\
    capi_kwlist,&opunit_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable opunit */
    f2py_success = int_from_pyobj(&opunit,opunit_capi,"_eposlhc.impy_closelogfile() 1st argument (opunit) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"initializeepos",-1,{{-1}},0,(char *)F_FUNC(initializeepos,INITIALIZEEPOS),(f2py_init_func)f2py_rout__eposlhc_initializeepos,doc_f2py_rout__eposlhc_initializeepos},
  ...
  {"setstable",-1,{{-1}},0,(char *)F_FUNC(setstable,SETSTABLE),(f2py_init_func)f2py_rout__eposlhc_setstable,doc_f2py_rout__eposlhc_setstable},
  {"setunstable",-1,{{-1}},0,(char *)F_FUNC(setunstable,SETUNSTABLE),(f2py_init_func)f2py_rout__eposlhc_setunstable,doc_f2py_rout__eposlhc_setunstable},
  ...
  {"init_rmmard",-1,{{-1}},0,(char *)F_FUNC_US(init_rmmard,INIT_RMMARD),(f2py_init_func)f2py_rout__eposlhc_init_rmmard,doc_f2py_rout__eposlhc_init_rmmard},
  {"impy_openlogfile",-1,{{-1}},0,(char *)F_FUNC_US(impy_openlogfile,IMPY_OPENLOGFILE),(f2py_init_func)f2py_rout__eposlhc_impy_openlogfile,doc_f2py_rout__eposlhc_impy_openlogfile},
  {"impy_closelogfile",-1,{{-1}},0,(char *)F_FUNC_US(impy_closelogfile,IMPY_CLOSELOGFILE),(f2py_init_func)f2py_rout__eposlhc_impy_closelogfile,doc_f2py_rout__eposlhc_impy_closelogfile},
