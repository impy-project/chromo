 ...
 * Generation date: Tue Oct 18 15:00:28 2022
...
extern void F_FUNC(initializeepos,INITIALIZEEPOS)(float*,float*,string,int*,int*,int*,int*,int*,int*,size_t);
extern void F_FUNC(initeposevt,INITEPOSEVT)(float*,float*,int*,int*);
...
static PyObject *f2py_rout__eposlhc_initializeepos(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,string,int*,int*,int*,int*,int*,int*,size_t)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
    ...
    static char *capi_kwlist[] = {"seed","emax","datpath","lpath","ifram","ippdg","itpdg","idebug","iou",NULL};
...
#endif
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOOOOOOOO|:_eposlhc.initializeepos",\
        capi_kwlist,&seed_capi,&emax_capi,&datpath_capi,&lpath_capi,&ifram_capi,&ippdg_capi,&itpdg_capi,&idebug_capi,&iou_capi))
        return NULL;
/*frompyobj*/
    ...
    if (f2py_success) {
        STRINGPADN(datpath, slen(datpath), '\0', ' ');
    ...
    /* Processing variable idebug */
        f2py_success = int_from_pyobj(&idebug,idebug_capi,"_eposlhc.initializeepos() 8th argument (idebug) can't be converted to int");
    if (f2py_success) {
    /* Processing variable iou */
        f2py_success = int_from_pyobj(&iou,iou_capi,"_eposlhc.initializeepos() 9th argument (iou) can't be converted to int");
    if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
                (*f2py_func)(&seed,&emax,datpath,&lpath,&ifram,&ippdg,&itpdg,&idebug,&iou,slen(datpath));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*decl*/
    ...
    int itpdg = 0;
    PyObject *itpdg_capi = Py_None;
    static char *capi_kwlist[] = {"ecm","ela","ippdg","itpdg",NULL};
...
#endif
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOOO|:_eposlhc.initeposevt",\
        capi_kwlist,&ecm_capi,&ela_capi,&ippdg_capi,&itpdg_capi))
        return NULL;
/*frompyobj*/
...
PyMODINIT_FUNC PyInit__eposlhc(void) {
    ...
    s = PyUnicode_FromString(
        "This module '_eposlhc' is auto-generated with f2py (version:1.23.1).\nFunctions:\n"
"    aaset(iop)\n"
"    hepmcstore()\n"
"    afinal()\n"
"    ainit()\n"
