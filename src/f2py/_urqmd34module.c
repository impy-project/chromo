 ...
 * Generation date: Mon Aug 15 18:46:56 2022
...
static FortranDataDef f2py_terms_def[] = {
  {"mass",0,{{-1}},NPY_FLOAT},
  {"tem",0,{{-1}},NPY_FLOAT},
  {"mui",0,{{-1}},NPY_FLOAT},
  {"dsttilde",0,{{-1}},NPY_FLOAT},
  {"dsxtilde",0,{{-1}},NPY_FLOAT},
  {"dsztilde",0,{{-1}},NPY_FLOAT},
  {"gamma",0,{{-1}},NPY_FLOAT},
  {"vtilde",0,{{-1}},NPY_FLOAT},
  {"pm",0,{{-1}},NPY_INT},
  {NULL}
};

static void f2py_setup_terms(char *mass,char *tem,char *mui,char *dsttilde,char *dsxtilde,char *dsztilde,char *gamma,char *vtilde,char *pm) {
  int i_f2py=0;
  f2py_terms_def[i_f2py++].data = mass;
  f2py_terms_def[i_f2py++].data = tem;
  f2py_terms_def[i_f2py++].data = mui;
  f2py_terms_def[i_f2py++].data = dsttilde;
  f2py_terms_def[i_f2py++].data = dsxtilde;
  f2py_terms_def[i_f2py++].data = dsztilde;
  f2py_terms_def[i_f2py++].data = gamma;
  f2py_terms_def[i_f2py++].data = vtilde;
  f2py_terms_def[i_f2py++].data = pm;
}
extern void F_FUNC(f2pyinitterms,F2PYINITTERMS)(void (*)(char*,char*,char*,char*,char*,char*,char*,char*,char*));
static void f2py_init_terms(void) {
  F_FUNC(f2pyinitterms,F2PYINITTERMS)(f2py_setup_terms);
}
...
#else
#define RETVAL
PyMODINIT_FUNC init_urqmd34(void) {
#endif
  int i;
  PyObject *m,*d, *s, *tmp;
#if PY_VERSION_HEX >= 0x03000000
...
#else
  m = _urqmd34_module = Py_InitModule("_urqmd34", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _urqmd34 (failed to import numpy)"); return RETVAL;}
...
#else
      s = PyString_FromString("partname");
#endif
...
#else
      s = PyString_FromString("ptsigtot");
#endif
      PyObject_SetAttrString(o,"__name__", s);
      Py_DECREF(s);
    }
...
/*eof initf2pywraphooks*/
  PyDict_SetItemString(d, "terms", PyFortranObject_New(f2py_terms_def,f2py_init_terms));
/*eof initf90modhooks*/
