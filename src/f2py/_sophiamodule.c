 ...
 * Generation date: Mon Aug 15 13:16:34 2022
...
/******************************** init_rmmard ********************************/
static char doc_f2py_rout__sophia_init_rmmard[] = "\
init_rmmard(iseedin)\n\nWrapper for ``init_rmmard``.\
\n\nParameters\n----------\n"
"iseedin : input int";
/* extern void F_FUNC_US(init_rmmard,INIT_RMMARD)(int*); */
static PyObject *f2py_rout__sophia_init_rmmard(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:_sophia.init_rmmard",\
    capi_kwlist,&iseedin_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable iseedin */
    f2py_success = int_from_pyobj(&iseedin,iseedin_capi,"_sophia.init_rmmard() 1st argument (iseedin) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"init_rmmard",-1,{{-1}},0,(char *)F_FUNC_US(init_rmmard,INIT_RMMARD),(f2py_init_func)f2py_rout__sophia_init_rmmard,doc_f2py_rout__sophia_init_rmmard},
...
#else
#define RETVAL
PyMODINIT_FUNC init_sophia(void) {
#endif
  int i;
  PyObject *m,*d, *s, *tmp;
#if PY_VERSION_HEX >= 0x03000000
...
#else
  m = _sophia_module = Py_InitModule("_sophia", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _sophia (failed to import numpy)"); return RETVAL;}
...
#else
      s = PyString_FromString("crossection");
#endif
...
#else
      s = PyString_FromString("icon_pdg_sib");
#endif
      PyObject_SetAttrString(o,"__name__", s);
      Py_DECREF(s);
    }
