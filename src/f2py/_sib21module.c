 ...
 * Generation date: Tue Oct  4 09:30:24 2022
...
/*********************************** gasdev ***********************************/
static char doc_f2py_rout__sib21_gasdev[] = "\
gasdev = gasdev(idum)\n\nWrapper for ``gasdev``.\
\n\nParameters\n----------\n"
"idum : input int\n"
"\nReturns\n-------\n"
"gasdev : float";
/* extern void F_WRAPPEDFUNC(gasdev,GASDEV)(double*,int*); */
static PyObject *f2py_rout__sib21_gasdev(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable idum */
    f2py_success = int_from_pyobj(&idum,idum_capi,"_sib21.gasdev() 1st argument (idum) can't be converted to int");
  if (f2py_success) {
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"gasdev",-1,{{-1}},0,(char *)F_WRAPPEDFUNC(gasdev,GASDEV),(f2py_init_func)f2py_rout__sib21_gasdev,doc_f2py_rout__sib21_gasdev},
