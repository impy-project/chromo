 ...
 * Generation date: Wed Aug 23 13:19:25 2023
...
extern void F_FUNC(glauber,GLAUBER)(int*,float*,float*,float*,float*,float*,float*);
...
/********************************** glauber **********************************/
static char doc_f2py_rout__sib21_glauber[] = "\
glauber(ja,ssig,slope,alpha,sigt,sigel,sigqel)\n\nWrapper for ``glauber``.\
\n\nParameters\n----------\n"
"ja : input int\n"
"ssig : input float\n"
"slope : input float\n"
...
"sigqel : input float";
/* extern void F_FUNC(glauber,GLAUBER)(int*,float*,float*,float*,float*,float*,float*); */
static PyObject *f2py_rout__sib21_glauber(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*decl*/
  ...
  float ssig = 0;
  PyObject *ssig_capi = Py_None;
  float slope = 0;
  PyObject *slope_capi = Py_None;
  float alpha = 0;
  PyObject *alpha_capi = Py_None;
  float sigt = 0;
  PyObject *sigt_capi = Py_None;
  float sigel = 0;
  PyObject *sigel_capi = Py_None;
  float sigqel = 0;
  PyObject *sigqel_capi = Py_None;
  static char *capi_kwlist[] = {"ja","ssig","slope","alpha","sigt","sigel","sigqel",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOO|:_sib21.glauber",\
    capi_kwlist,&ja_capi,&ssig_capi,&slope_capi,&alpha_capi,&sigt_capi,&sigel_capi,&sigqel_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable ja */
    f2py_success = int_from_pyobj(&ja,ja_capi,"_sib21.glauber() 1st argument (ja) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ssig */
    f2py_success = float_from_pyobj(&ssig,ssig_capi,"_sib21.glauber() 2nd argument (ssig) can't be converted to float");
  if (f2py_success) {
  /* Processing variable slope */
    f2py_success = float_from_pyobj(&slope,slope_capi,"_sib21.glauber() 3rd argument (slope) can't be converted to float");
  if (f2py_success) {
  /* Processing variable alpha */
    f2py_success = float_from_pyobj(&alpha,alpha_capi,"_sib21.glauber() 4th argument (alpha) can't be converted to float");
  if (f2py_success) {
  /* Processing variable sigt */
    f2py_success = float_from_pyobj(&sigt,sigt_capi,"_sib21.glauber() 5th argument (sigt) can't be converted to float");
  if (f2py_success) {
  /* Processing variable sigel */
    f2py_success = float_from_pyobj(&sigel,sigel_capi,"_sib21.glauber() 6th argument (sigel) can't be converted to float");
  if (f2py_success) {
  /* Processing variable sigqel */
    f2py_success = float_from_pyobj(&sigqel,sigqel_capi,"_sib21.glauber() 7th argument (sigqel) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
        (*f2py_func)(&ja,&ssig,&slope,&alpha,&sigt,&sigel,&sigqel);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  } /*if (f2py_success) of sigqel*/
  /* End of cleaning variable sigqel */
  } /*if (f2py_success) of sigel*/
  /* End of cleaning variable sigel */
  } /*if (f2py_success) of sigt*/
  /* End of cleaning variable sigt */
  } /*if (f2py_success) of alpha*/
  /* End of cleaning variable alpha */
  } /*if (f2py_success) of slope*/
  /* End of cleaning variable slope */
  } /*if (f2py_success) of ssig*/
  /* End of cleaning variable ssig */
  } /*if (f2py_success) of ja*/
...
static FortranDataDef f2py_ca0sh_def[] = {
  {"r0",0,{{-1}},NPY_FLOAT},
  {"r02",0,{{-1}},NPY_FLOAT},
  {NULL}
};
static void f2py_setup_ca0sh(char *r0,char *r02) {
  int i_f2py=0;
  f2py_ca0sh_def[i_f2py++].data = r0;
  f2py_ca0sh_def[i_f2py++].data = r02;
}
extern void F_FUNC(f2pyinitca0sh,F2PYINITCA0SH)(void(*)(char*,char*));
static void f2py_init_ca0sh(void) {
  F_FUNC(f2pyinitca0sh,F2PYINITCA0SH)(f2py_setup_ca0sh);
}
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"glauber",-1,{{-1}},0,(char *)F_FUNC(glauber,GLAUBER),(f2py_init_func)f2py_rout__sib21_glauber,doc_f2py_rout__sib21_glauber},
...
/*eof initf90modhooks*/
  ...
  Py_DECREF(tmp);
  tmp = PyFortranObject_New(f2py_ca0sh_def,f2py_init_ca0sh);
  F2PyDict_SetItemString(d, "ca0sh", tmp);
  Py_DECREF(tmp);
