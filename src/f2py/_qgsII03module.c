 ...
 * Generation date: Thu Sep 15 14:05:16 2022
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOO|:_qgsII03.cqgsini",\
    capi_kwlist,&seedin_capi,&datdir_capi,&lun_capi,&debugnum_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable seedin */
    f2py_success = int_from_pyobj(&seedin,seedin_capi,"_qgsII03.cqgsini() 1st argument (seedin) can't be converted to int");
  if (f2py_success) {
  /* Processing variable datdir */
  slen(datdir) = 256;
  f2py_success = string_from_pyobj(&datdir,&slen(datdir),"",datdir_capi,"string_from_pyobj failed in converting 2nd argument `datdir' of _qgsII03.cqgsini to C string");
  if (f2py_success) {
  /* Processing variable lun */
    f2py_success = int_from_pyobj(&lun,lun_capi,"_qgsII03.cqgsini() 3rd argument (lun) can't be converted to int");
  if (f2py_success) {
  /* Processing variable debugnum */
    f2py_success = int_from_pyobj(&debugnum,debugnum_capi,"_qgsII03.cqgsini() 4th argument (debugnum) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/****************************** impy_openlogfile ******************************/
static char doc_f2py_rout__qgsII03_impy_openlogfile[] = "\
impy_openlogfile(fname,opunit)\n\nWrapper for ``impy_openlogfile``.\
\n\nParameters\n----------\n"
"fname : input string(len=300)\n"
"opunit : input int";
/* extern void F_FUNC_US(impy_openlogfile,IMPY_OPENLOGFILE)(string,int*,size_t); */
static PyObject *f2py_rout__qgsII03_impy_openlogfile(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO|:_qgsII03.impy_openlogfile",\
    capi_kwlist,&fname_capi,&opunit_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable fname */
  slen(fname) = 300;
  f2py_success = string_from_pyobj(&fname,&slen(fname),"",fname_capi,"string_from_pyobj failed in converting 1st argument `fname' of _qgsII03.impy_openlogfile to C string");
  if (f2py_success) {
  /* Processing variable opunit */
    f2py_success = int_from_pyobj(&opunit,opunit_capi,"_qgsII03.impy_openlogfile() 2nd argument (opunit) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/***************************** impy_closelogfile *****************************/
static char doc_f2py_rout__qgsII03_impy_closelogfile[] = "\
impy_closelogfile(opunit)\n\nWrapper for ``impy_closelogfile``.\
\n\nParameters\n----------\n"
"opunit : input int";
/* extern void F_FUNC_US(impy_closelogfile,IMPY_CLOSELOGFILE)(int*); */
static PyObject *f2py_rout__qgsII03_impy_closelogfile(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_qgsII03.impy_closelogfile",\
    capi_kwlist,&opunit_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable opunit */
    f2py_success = int_from_pyobj(&opunit,opunit_capi,"_qgsII03.impy_closelogfile() 1st argument (opunit) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************** init_rmmard ********************************/
static char doc_f2py_rout__qgsII03_init_rmmard[] = "\
init_rmmard(iseedin)\n\nWrapper for ``init_rmmard``.\
\n\nParameters\n----------\n"
"iseedin : input int";
/* extern void F_FUNC_US(init_rmmard,INIT_RMMARD)(int*); */
static PyObject *f2py_rout__qgsII03_init_rmmard(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O|:_qgsII03.init_rmmard",\
    capi_kwlist,&iseedin_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable iseedin */
    f2py_success = int_from_pyobj(&iseedin,iseedin_capi,"_qgsII03.init_rmmard() 1st argument (iseedin) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"impy_openlogfile",-1,{{-1}},0,(char *)F_FUNC_US(impy_openlogfile,IMPY_OPENLOGFILE),(f2py_init_func)f2py_rout__qgsII03_impy_openlogfile,doc_f2py_rout__qgsII03_impy_openlogfile},
  {"impy_closelogfile",-1,{{-1}},0,(char *)F_FUNC_US(impy_closelogfile,IMPY_CLOSELOGFILE),(f2py_init_func)f2py_rout__qgsII03_impy_closelogfile,doc_f2py_rout__qgsII03_impy_closelogfile},
  {"init_rmmard",-1,{{-1}},0,(char *)F_FUNC_US(init_rmmard,INIT_RMMARD),(f2py_init_func)f2py_rout__qgsII03_init_rmmard,doc_f2py_rout__qgsII03_init_rmmard},
