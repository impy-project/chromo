 ...
 * Generation date: Sun Jan 15 13:00:03 2023
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO|:_qgsII04.cqgsini",\
    capi_kwlist,&datdir_capi,&lun_capi,&debugnum_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable datdir */
  slen(datdir) = 256;
  f2py_success = string_from_pyobj(&datdir,&slen(datdir),"",datdir_capi,"string_from_pyobj failed in converting 1st argument `datdir' of _qgsII04.cqgsini to C string");
  if (f2py_success) {
  /* Processing variable lun */
    f2py_success = int_from_pyobj(&lun,lun_capi,"_qgsII04.cqgsini() 2nd argument (lun) can't be converted to int");
  if (f2py_success) {
  /* Processing variable debugnum */
    f2py_success = int_from_pyobj(&debugnum,debugnum_capi,"_qgsII04.cqgsini() 3rd argument (debugnum) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/*********************************** npyrng ***********************************/
static char doc_f2py_rout__qgsII04_npyrng[] = "\
npyrng(rval)\n\nWrapper for ``npyrng``.\
\n\nParameters\n----------\n"
"rval : input float";
/* extern void F_FUNC(npyrng,NPYRNG)(double*); */
static PyObject *f2py_rout__qgsII04_npyrng(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable rval */
    f2py_success = double_from_pyobj(&rval,rval_capi,"_qgsII04.npyrng() 1st argument (rval) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"npyrng",-1,{{-1}},0,(char *)F_FUNC(npyrng,NPYRNG),(f2py_init_func)f2py_rout__qgsII04_npyrng,doc_f2py_rout__qgsII04_npyrng},
