# FIXME This test is superseded by test_generators.py
# This test generates some files for inspection, so should be run manually,
# not automatically by CI. We can keep it in this directory, if we do not call
# it test_X.py, it is ignored by pytest.
